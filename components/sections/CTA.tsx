...
export default function CTASection() {
  return (
    <div className="flex flex-col p-12 gap-8 mt-8 sm:mt-16 mb-16 items-center sm:items-start justify-center sm:justify-start text-center sm:text-start rounded-4xl text-amber-500  bg-gradient-to-r from-blue-800 to-blue-600">
